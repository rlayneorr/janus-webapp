...
export class ReportingService {
  ...
  public batchOverallRadar$ = this.batchOverallRadarSubject.asObservable();
  ...
  */
  ...
  fetchBatchOverallRadarChart(batchId: Number) {
    const endpoint = `http://localhost:8070/all/reports/batch/${batchId}/overall/radar-batch-overall`;
