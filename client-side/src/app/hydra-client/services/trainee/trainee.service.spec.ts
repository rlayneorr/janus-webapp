...
fdescribe('TraineeService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [TraineeService, UrlService],
  ...
  it(`should findAllByBatchAndStatus and verify the response`,
    async(
      inject([HttpClient, HttpTestingController, TraineeService],
        (http: HttpClient, backend: HttpTestingController, service: TraineeService) => {
