...
export class Trainee extends User{
    ...
    constructor(userId?: number, resourceId?: number, trainingStatus?: string, batch?: HydraBatch,
        firstName?: string, middleName?: string, lastName?: string, email?: string, password?: 
        string, backupPassword?: string, role?: UserRole, mobilePhone?: string, homePhone?: string, 
        token?: string, profileUrl?: string, recruiterName?: string, 
